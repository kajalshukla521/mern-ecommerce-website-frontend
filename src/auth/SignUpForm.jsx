...
import loginIcons from '../assest/signin.jpg'
...
const SignUp = () => {
    ...
    const handleUploadPic = async (e) => {
        ...
        try {
            // Convert to Base64
            const imagePic = await imageTobase64(file);
            console.log("Base64 Image:", imagePic); // Debug to check Base64 conversion
            setData((prev) => ({
                ...prev,
                profilePic: imagePic,
            }));
    ...
    const handleSubmit = async (e) => {
        ...
        if (data.password === data.confirmPassword) {
            console.log("SummaryApi.SignUp.ur", SummaryApi.SignUp.ur)
            ...
            <div className='mx-auto container p-4'>
                ...
                <div className='bg-white p-5 w-full max-w-sm mx-auto'>
                    ...
                    <div className='w-20 h-20 mx-auto relative overflow-hidden rounded-full'>
                        <div>
                        <img src={data.profilePic || loginIcons} alt='Profile Pic' />
                    ...
                    <p className='my-5'>Already have account ? <Link to={"/login-form"} className=' text-red-600 hover:text-red-700 hover:underline'>Login</Link></p>
                </div>
